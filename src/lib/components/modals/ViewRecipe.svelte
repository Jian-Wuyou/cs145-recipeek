...
{#if $modalStore[0]}
    <div class="bg-surface-100-800-token h-[90dvh] w-full max-w-3xl rounded-xl p-4 max-sm:overflow-y-auto">
        <div class="flex max-sm:flex-col max-sm:divide-y-[1px] sm:flex-row sm:divide-x-[1px]">
            ...
            <div class="max-sm:w-full max-sm:pt-4 sm:h-full sm:w-[60%] sm:overflow-y-auto sm:pl-4">
